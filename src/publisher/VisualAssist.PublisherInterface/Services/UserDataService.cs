...
using VisualAssist.PublisherInterface.Core.Helpers;
using VisualAssist.PublisherInterface.Core.Models;
using VisualAssist.PublisherInterface.Core.Services;
using VisualAssist.PublisherInterface.Helpers;
using VisualAssist.PublisherInterface.ViewModels;

using Windows.Storage;

namespace VisualAssist.PublisherInterface.Services
{
